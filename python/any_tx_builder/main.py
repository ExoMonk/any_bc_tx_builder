...
from evm.config import TWINSTAKE_VALIDATOR_ADDRESS, POLYGON_STAKING_CONTRACT
...
def main():
    ...
    # Delegation
    validator_address = "0x02a9F16b353410f150Fb25F7983B3DC90Db4679D"#TWINSTAKE_VALIDATOR_ADDRESS
